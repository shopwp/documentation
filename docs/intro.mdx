...
Formerly known as ~~WP Shopify~~, ShopWP comes bundled with a ready-to-use <a href="#!" className="shopwp-cart-trigger">cart experience</a>. This cart is powered by JavaScript and "slides in" without any additional page loads. <a href="#!" className="shopwp-cart-trigger">Try it out!</a> When a user is ready to checkout, ShopWP sends them to the default Shopify checkout page to place the order and provide the payment.
