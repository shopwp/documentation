...
import ShopWP from '@site/src/components/shop'
import { ProductsSingle } from '@site/src/components/products'
...
Both versions come bundled with a ready-to-use <a href="#!" class="shopwp-cart-trigger">cart experience</a>. This cart is powered by JavaScript, and "slides in" to view without needing additional page loads. When a user is ready to checkout, they're redirected to the default Shopify checkout page to place the order.
...
<ShopWP showCart={true}>
	<ProductsSingle customSettings={{ limit: 3, itemsPerRow: 3 }} />
</ShopWP>
