...
| [with_sorting](#with_sorting)                                                       | `false`       | Determines whether to show a sorting / filtering dropdown with the products                |
...
| [variant_dropdown_text_color](#variant_dropdown_text_color)                         | `#FFFFFF`     | Customizes the text color of the variant dropdown                                          |
