...
| [subscriptions_autoload](#subscriptions_autoload)                                   | `false`       | Determines whether the subscription data will show on page load or not                                                     |
...
Determines whether the subscription data will show on page load or not. Useful if you wish to show subscription prices without forcing the user to click on the subscription tab first.
...
```js
[wps_products subscriptions_autoload="true"]
```
