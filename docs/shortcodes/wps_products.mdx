...
| [pagination_load_more_text](#pagination_load_more_text)                             | `false`       | Allows for customizing the "load more" button text shown for product pagination            |
...
<Products
	settings={{ subscriptions: true, query: 'title:"Super awesome sunglasses"' }}
/>
...
<Products settings={{ directCheckout: true }} showCart={true} />
