...
| [subscriptions_select_on_load](#subscriptions_select_on_load)                       | `false`                   | Whether to automatically select subscriptions on load                                                                      |
| [subscriptions_details_text](#subscriptions_details_text)                           | See below                 | This will be the text that shows in the subscription tooltip                                                               |
| [subscriptions_details_heading](#subscriptions_details_heading)                     | `How subscriptions work:` | The tooltip heading text                                                                                                   |
| [subscriptions_details_label](#subscriptions_details_label)                         | `Subscription details`    | The subscriptions details text                                                                                             |
| [subscriptions_hide_onetime](#subscriptions_hide_onetime)                           | `false`                   | Whether to always hide the "one time" subscription option                                                                  |
...
| [show_pricing_above_add_to_cart_button](#show_pricing_above_add_to_cart_button)     | `false`                   | Determines whether to show the pricing component above the add to cart button or not. Default `false`.                     |
...
| [link_to_url](#link_to_url)                                                         | `false`                   | Allows for setting a custom URL that the product should link to                                                            |
...
| [product_metafields](#product_metafields)                                           | `false`                   | Allows for whitelisting certain product metafields to be returned in the JavaScript payload                                |
| [product_variant_metafields](#product_variant_metafields)                           | `false`                   | Allows for whitelisting certain product variant metafields to be returned in the JavaScript payload                        |
...
Display products based on their availability. Passing `true` will only show products that are in stock. The default behavior is to show both in stock and out of stock products.

If you're filtering products by collection, you may also pass `false` which means "show only out of stock products".

| Possible values            |
| :------------------------- |
| `true`                     |
| `false` (collections only) |
| `any` (default)            |
...
**Example:** Only show products that are out-of-stock (only works when filtering by collection)
...
You will then need to pass this array into a [base64 encoder](https://www.base64encode.org/).
