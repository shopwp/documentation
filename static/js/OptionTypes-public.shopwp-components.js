"use strict";
(self["webpackChunkshopwpComponents"] = self["webpackChunkshopwpComponents"] || []).push([["OptionTypes-public"],{

/***/ "./src/components/storefront/options/option-types/index.jsx":
/*!******************************************************************!*\
  !*** ./src/components/storefront/options/option-types/index.jsx ***!
  \******************************************************************/
...
function OptionTypes(_ref) {
  var settings = _ref.settings;
  var shouldOpen = (0,Utils__WEBPACK_IMPORTED_MODULE_1__.shouldOpenOnLoad)(settings, "productTypes");
  ...
  return /*#__PURE__*/React.createElement(StorefrontFilterOptionsGroupOption, {
    ...
    queryFn: Api__WEBPACK_IMPORTED_MODULE_0__.getAllTypes,
    groupType: "types",
...
/* harmony default export */ __webpack_exports__["default"] = (OptionTypes);

/***/ })

}]);
//# sourceMappingURL=OptionTypes-public.shopwp-components.js.map