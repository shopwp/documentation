"use strict";
(self["webpackChunkshopwpComponents"] = self["webpackChunkshopwpComponents"] || []).push([["StorefrontPageSize-public"],{

/***/ "./src/components/storefront/page-size/index.jsx":
/*!*******************************************************!*\
  !*** ./src/components/storefront/page-size/index.jsx ***!
  \*******************************************************/
...
function StorefrontPageSize() {
  ...
  var options = itemsState.settings.sortingOptionsPageSize;

  function customOnChange(data) {
    itemsDispatch({
      type: "SET_QUERY_PARAMS",
      payload: _objectSpread(_objectSpread({}, itemsState.queryParams), {}, {
  ...
  return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(_selects__WEBPACK_IMPORTED_MODULE_3__["default"], {
    dropzone: itemsState.settings.dropzonePageSize,
    labelText: itemsState.settings.pageSizeLabelText,
    selectId: "swp-pagesize",
    options: options,
    isLoading: itemsState.isLoading,
    customOnChange: customOnChange,
    defaultValue: (0,Utils__WEBPACK_IMPORTED_MODULE_2__.findDefaultSelectVal)(options, itemsState.settings.pageSize)
  });
}

/* harmony default export */ __webpack_exports__["default"] = (StorefrontPageSize);

/***/ })

}]);
//# sourceMappingURL=StorefrontPageSize-public.shopwp-components.js.map